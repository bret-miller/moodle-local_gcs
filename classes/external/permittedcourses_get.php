...
/**
 * Get current list of permitted courses for GCS Program Management
 *
 * @package    local_gcs
...
require_once(__dir__.'/recorddefs/permittedcourse.php');
 ...
 */
class permittedcourses_get extends \external_api {
    /**
    ...
    public static function execute_parameters() {
        return new external_function_parameters([
            'programcode' => new external_value(
                PARAM_TEXT,
                'get permitted courses for this program, or empty for all programs',
                VALUE_REQUIRED),
        ]);
    }
    /**
    ...
    public static function execute_returns() {
        $def = new permittedcourserecord();
        return new external_multiple_structure(
            new external_single_structure($def->recdef)
        );
    }
    /**
     * Get current list of permitted courses
     * @param string $programcode program code
     * @return hash of permitted courses records
     */
    public static function execute($programcode) {
        $permittedcourses = \local_gcs\data::get_courses_permitted($programcode);

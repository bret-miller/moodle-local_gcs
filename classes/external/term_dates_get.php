...
/**
 * Get a term definition record for GCS Program Management
 *
 * @package    local_gcs
...
/**
 * Get term definition record
 */
class term_dates_get extends \external_api {
    /**
    ...
    public static function execute_parameters() {
        return new external_function_parameters([
            'id' => new external_value(PARAM_INT, 'term definition record id'),
        ]);
    }
    /**
     ...
     * @param  int  $id  id of term dates record to get
     * @return object program record
     */
    public static function execute($id) {
        $program = \local_gcs\data::get_term_dates($id);
        return $program;
    }
}

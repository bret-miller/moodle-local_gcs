...
/**
 * Get enrollment agreements for GCS Program Management
 *
 * @package    local_gcs
...
/**
 * Get list of enrollment agreements
 */
class enrollment_agreements_get_all extends \external_api {
    /**
    ...
    /**
     * Get current list of enrollment agreements
     * @return hash of enrollment agreement records
     */
    public static function execute() {
        $recs = \local_gcs\data::get_enrollment_agreements_all();
        return $recs;
    }
}

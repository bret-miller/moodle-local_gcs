...
/**
 * Get list of accounting scholarship categories
 *
 * @package    local_gcs
...
/**
 * Delete accounting scholarship category record
 */
class sch_cat_delete extends \external_api {
    /**
     ...
     * @param  int  $id  id of record to delet
     * @return hash of program records
     */
    public static function execute($id) {
        $programs = \local_gcs\data::delete_sch_cat($id);
        return;
    }
}

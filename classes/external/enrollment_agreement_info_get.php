 ...
 */
class enrollment_agreement_info_get extends \external_api {
    /**
     ...
     * @return records
     */
    public static function execute($eaid) {
        return \local_gcs\data::format_enrollment_agreement_info($eaid);
    }
}

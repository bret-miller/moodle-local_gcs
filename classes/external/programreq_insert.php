...
/**
 * Insert a program requirement for GCS Program Management
 *
 * @package    local_gcs
...
/**
 * Insert a program requirement record
 */
class programreq_insert extends \external_api {
    /**
    ...
    public static function execute($rec) {
        $program = \local_gcs\data::insert_program_req($rec);
        return $program;
    }
}

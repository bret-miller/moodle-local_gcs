...
/**
 * Get program completion for GCS Program Management
 *
 * @package    local_gcs
...
/**
 * Get list of program completion
 */
class program_completion_get_all extends \external_api {
    /**
    ...
    public static function execute_parameters() {
        ...
        //    'studentid' => new external_value(PARAM_TEXT, 'student id or empty for all students', VALUE_REQUIRED),
    ...
    /**
     * Get current list of program completion
     * @return hash of program completion records
     */
    public static function execute() {
        $recs = \local_gcs\data::get_program_completion_all();
        return $recs;
    }
}

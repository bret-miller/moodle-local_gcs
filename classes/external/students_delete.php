...
/**
 * Delete a student record for GCS Program Management
 *
 * @package    local_gcs
 ...
 */
class students_delete extends \external_api {
    /**
     ...
     * @param int $id student record id
     */
    public static function execute($id) {
        $program = \local_gcs\data::delete_students($id);
        return;
    }
}

...
/**
 * Get a student record for GCS Program Management using the partial name
 *
 * @package    local_gcs
...
require_once(__dir__.'/recorddefs/student.php');
 ...
 */
class students_get_by_name extends \external_api {
    /**
    ...
    public static function execute_parameters() {
        return new external_function_parameters([
            'firstname' => new external_value(PARAM_TEXT, 'partial first name'),
            'lastname' => new external_value(PARAM_TEXT, 'partial last name'),
        ]);
    }
    /**
    ...
    public static function execute($fn, $ln) {
        $recs = \local_gcs\data::get_students_by_name($fn, $ln);
        return $recs;
    }
}

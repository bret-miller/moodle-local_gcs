...
/**
 * Delete a course permitted record for GCS Program Management
 *
 * @package    local_gcs
...
/**
 * Delete course permitted record
 */
class permittedcourse_delete extends \external_api {
    /**
    ...
    /**
     * Delete a permitted course record
     * @param int $id course permitted record id
     */
    public static function execute($id) {
        $permittedcourse = \local_gcs\data::delete_course_permitted($id);
        return;
    }
}

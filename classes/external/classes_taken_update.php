...
/**
 * Update an classes taken record for GCS Program Management
 *
 * @package    local_gcs
...
/**
 * Update classes taken record
 */
class classes_taken_update extends \external_api {
    /**
    ...
    /**
     * Update an classes taken record
     * @param object $rec classes takenrecord
     */
    public static function execute($rec) {
        $rec = (object) $rec;
        return \local_gcs\data::update_classes_taken($rec);
    }
}

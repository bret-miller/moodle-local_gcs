...
/**
 * Get an accounting scholarship category record
 *
 * @package    local_gcs
 ...
 */
class sch_cat_get extends \external_api {
    /**
     ...
     * @param  int  $id  id of category record to get
     * @return object program record
     */
    public static function execute($id) {
        $programs = \local_gcs\data::get_sch_cat($id);
        return $programs;
    }
}

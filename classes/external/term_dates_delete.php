...
/**
 * Delete a term definition record for GCS Program Management
 *
 * @package    local_gcs
...
/**
 * Delete term definition record
 */
class term_dates_delete extends \external_api {
    /**
    ...
    public static function execute($id) {
        $program = \local_gcs\data::delete_term_dates($id);
        return;
    }
}

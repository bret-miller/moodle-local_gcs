...
/**
 * Get a student record for GCS Program Management using the email address
 *
 * @package    local_gcs
 ...
 */
class students_get_by_email extends \external_api {
    /**
     ...
     * @param  string  $email  email address of student record to get
     * @return array of student records
     */
    public static function execute($email) {
        $recs = \local_gcs\data::get_students_by_email($email);
        return $recs;
    }
}

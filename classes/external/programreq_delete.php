...
/**
 * Delete a program requirement record for GCS Program Management
 *
 * @package    local_gcs
...
/**
 * Delete program requirement record
 */
class programreq_delete extends \external_api {
    /**
    ...
    public static function execute($id) {
        $programreq = \local_gcs\data::delete_program_req($id);
        return;
    }
}

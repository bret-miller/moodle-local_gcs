...
/**
 * Insert program completion record for GCS Program Management
 *
 * @package    local_gcs
...
/**
 * Insert program completion record
 */
class program_completion_insert extends \external_api {
    /**
    ...
    public static function execute($rec) {
        $srec = \local_gcs\data::insert_program_completion($rec);
        return $srec;
    }
}

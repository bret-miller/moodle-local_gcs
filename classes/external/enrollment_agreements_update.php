...
/**
 * Update an enrollment agreement record for GCS Program Management
 *
 * @package    local_gcs
...
/**
 * Update enrollment agreement record
 */
class enrollment_agreements_update extends \external_api {
    /**
    ...
    /**
     * Update an enrollment agreement record
     * @param object $rec enrollment agreement record
     */
    public static function execute($rec) {
        $rec = (object) $rec;
        return \local_gcs\data::update_enrollment_agreements($rec);
    }
}

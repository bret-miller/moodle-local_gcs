...
/**
 * Update a student record for GCS Program Management
 *
 * @package    local_gcs
 ...
 */
class students_update extends \external_api {
    /**
    ...
    public static function execute_parameters() {
        ...
        return new external_function_parameters([
            'rec' => new external_single_structure($def->recdef, 'Student Record', VALUE_REQUIRED),
        ]);
    }
    /**
    ...
    public static function execute($rec) {
        $rec = (object) $rec;
        return \local_gcs\data::update_students($rec);
    }
}

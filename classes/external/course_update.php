...
/**
 * Update a course record for GCS Program Management
 *
 * @package    local_gcs
 ...
 */
class course_update extends \external_api {
    /**
     ...
     * @param object $courserec course record
     */
    public static function execute($courserec) {
        $rec = (object) $courserec;
        return \local_gcs\data::update_course($rec);
    }
}

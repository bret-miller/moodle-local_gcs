...
/**
 * Delete an scholarships available record for GCS Program Management
 *
 * @package    local_gcs
...
/**
 * Delete scholarships available record
 */
class sch_available_delete extends \external_api {
    /**
    ...
    /**
     * Delete a scholarships available record
     * @param int $id scholarships available record id
     */
    public static function execute($id) {
        $program = \local_gcs\data::delete_sch_available($id);
        return;
    }
}

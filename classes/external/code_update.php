...
/**
 * Update a code for GCS Program Management
 *
 * @package    local_gcs
 ...
 * Update code record
 */
class code_update extends \external_api {
    /**
    ...
    public static function execute_parameters() {
        ...
        return new external_function_parameters([
            'rec' => new external_single_structure($def->recdef, 'Code Record', VALUE_REQUIRED),
        ]);
    }
    /**
     ...
     * @param object $coderec code record
     */
    public static function execute($coderec) {
        $rec = (object) $coderec;
        return \local_gcs\data::update_code($rec);
    }
}

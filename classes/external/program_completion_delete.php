...
/**
 * Delete a program completion record for GCS Program Management
 *
 * @package    local_gcs
...
/**
 * Delete program completion record
 */
class program_completion_delete extends \external_api {
    /**
    ...
    /**
     * Delete a program completion record
     * @param int $id program completion record id
     */
    public static function execute($id) {
        $program = \local_gcs\data::delete_program_completion($id);
        return;
    }
}

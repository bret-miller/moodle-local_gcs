...
/**
 * Delete an scholarships given record for GCS Program Management
 *
 * @package    local_gcs
...
/**
 * Delete scholarships given record
 */
class sch_given_delete extends \external_api {
    /**
    ...
    /**
     * Delete a scholarships given record
     * @param int $id scholarships given record id
     */
    public static function execute($id) {
        $program = \local_gcs\data::delete_sch_given($id);
        return;
    }
}

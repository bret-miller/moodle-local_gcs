...
/**
 * Update program completion record for GCS Program Management
 *
 * @package    local_gcs
...
/**
 * Update program completion record
 */
class program_completion_update extends \external_api {
    /**
    ...
    public static function execute_parameters() {
        ...
        return new external_function_parameters([
            'rec' => new external_single_structure($def->recdef, 'program completion record', VALUE_REQUIRED),
        ]);
    }
    /**
    ...
    public static function execute($rec) {
        $rec = (object) $rec;
        return \local_gcs\data::update_program_completion($rec);
    }
}

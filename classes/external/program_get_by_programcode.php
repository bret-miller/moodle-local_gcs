...
/**
 * Get single program record
 */
class program_get_by_programcode extends \external_api {
    /**
    ...
    public static function execute_parameters() {
        return new external_function_parameters([
            'programcode' => new external_value(PARAM_TEXT, VALUE_REQUIRED),
        ]);
    }
    /**
    ...
    /**
     * Get a program record
     * @param  int  $id  id of program to get
     * @return object program record
     */
    public static function execute($programcode) {
        $program = \local_gcs\data::get_program_by_programcode($programcode);
        return $program;
    }
}

 ...
 */
class classes_taken_get_by_stu_year extends \external_api {
    /**
    ...
    public static function execute_parameters() {
        return new external_function_parameters([
            'stuid' => new external_value(PARAM_INT, 'student id', VALUE_REQUIRED),
    ...
    public static function execute($stuid, $termyear) {
        $recs = \local_gcs\data::get_classes_taken_by_stu_year($stuid, $termyear);
        return $recs;
    }
}

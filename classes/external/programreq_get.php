...
/**
 * Get a program requirement record for GCS Program Management
 *
 * @package    local_gcs
...
/**
 * Get single program requirement record
 */
class programreq_get extends \external_api {
    /**
    ...
    /**
     * Get a program requirement record
     * @param  int  $id  id of program requirement to get
     * @return object program requirement record
     */
    public static function execute($id) {
        $programreq = \local_gcs\data::get_program_req($id);
        return $programreq;
    }
}

...
/**
 * Get current list of classes for GCS Program Management
 *
 * @package    local_gcs
 ...
 * Get list of classes
 */
class classes_get extends \external_api {
    /**
    ...
    /**
     * Get current list of classes
     * @return hash of class records
     */
    public static function execute() {
        $classes = \local_gcs\data::get_classes();
        return $classes;
    }
}

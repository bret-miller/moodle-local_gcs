...
/**
 * Get an classes taken record for GCS Program Management
 *
 * @package    local_gcs
...
/**
 * Get classes taken record
 */
class classes_taken_get extends \external_api {
    /**
    ...
    public static function execute_parameters() {
        return new external_function_parameters([
            'id' => new external_value(PARAM_INT, 'classes taken record id'),
        ]);
    }
    /**
    ...
    /**
     * Get an classes taken record
     * @param  int  $id  id of classes taken record to get
     * @return object classes taken record
     */
    public static function execute($id) {
        $rec = \local_gcs\data::get_classes_taken($id);
        return $rec;
    }
}

...
/**
 * Delete an classes taken record for GCS Program Management
 *
 * @package    local_gcs
...
/**
 * Delete classes taken record
 */
class classes_taken_delete extends \external_api {
    /**
    ...
    /**
     * Delete a classes taken record
     * @param int $id classes taken record id
     */
    public static function execute($id) {
        $program = \local_gcs\data::delete_classes_taken($id);
        return;
    }
}

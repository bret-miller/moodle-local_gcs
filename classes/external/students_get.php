...
/**
 * Get a student record for GCS Program Management
 *
 * @package    local_gcs
 ...
 * Get student record
 */
class students_get extends \external_api {
    /**
    ...
    public static function execute_returns() {
        ...
        //return new external_multiple_structure($def->rec);
     ...
     * @param  int  $id  id of student record to get
     * @return object student record
     */
    public static function execute($id) {
        $rec = \local_gcs\data::get_student_by_id($id);
        return $rec;
    }
}

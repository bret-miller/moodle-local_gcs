...
class permittedcourserecord {
    ...
    public function __construct() {
        $this->recdef = [
                ...
                'programcode' => new external_value(PARAM_TEXT, 'program'),
                'categorycode' => new external_value(PARAM_TEXT, 'category'),
                'coursecode' => new external_value(PARAM_TEXT, 'course'),
                'electiveeligible' => new external_value(PARAM_BOOL, 'elective eligible?'),
            ];
    }
}

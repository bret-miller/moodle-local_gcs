...
/**
 * Insert a term definition record for GCS Program Management
 *
 * @package    local_gcs
 ...
 */
class term_dates_insert extends \external_api {
    /**
     ...
     * @return object term defnition record
     */
    ...
    /**
     * Insert a term definition record
     * @param object $rec term definition record
     */
    public static function execute($rec) {
        return \local_gcs\data::insert_term_dates($rec);
    }
}

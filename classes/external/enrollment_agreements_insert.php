...
/**
 * Insert an enrollment agreement record for GCS Program Management
 *
 * @package    local_gcs
...
/**
 * Insert an enrollment agreement record
 */
class enrollment_agreements_insert extends \external_api {
    /**
    ...
    public static function execute($rec) {
        $srec = \local_gcs\data::insert_enrollment_agreements($rec);
        return $srec;
    }
}

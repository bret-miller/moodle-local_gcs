...
class classes_taken {
    ...
    /** @var int changed date */
    public $changeddate;
    /** @var int changed by user id */
    ...
    private function fill($rec) {
        ...
        $this->classtuition = $rec->classtuition;
        ...
        $this->changeddate = $rec->changeddate;
        $this->changedbyuserid = $rec->changedbyuserid;
    }
